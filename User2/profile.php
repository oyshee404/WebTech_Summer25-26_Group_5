...
if($_SESSION["role"] == "Member" && "User2" != "User1") { Header("Location:../login.php"); exit(); }
if($_SESSION["role"] == "Trainer" && "User2" != "User2") { Header("Location:../login.php"); exit(); }
if($_SESSION["role"] == "Admin" && "User2" != "User3") { Header("Location:../login.php"); exit(); }
?>
<!DOCTYPE html>
<html lang="en-US">
<head>
...
<body>
<div class="header"><h1>Trainer Profile</h1></div>
<div class="topnav">
...
<tr><td><label for="specialty">Specialty:</label></td><td><input type="text" id="specialty" name="specialty" value="<?php echo $user["specialty"]; ?>"></td></tr>
