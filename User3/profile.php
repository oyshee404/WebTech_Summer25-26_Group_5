...
if($_SESSION["role"] == "Member" && "User3" != "User1") { Header("Location:../login.php"); exit(); }
if($_SESSION["role"] == "Trainer" && "User3" != "User2") { Header("Location:../login.php"); exit(); }
if($_SESSION["role"] == "Admin" && "User3" != "User3") { Header("Location:../login.php"); exit(); }
?>
<!DOCTYPE html>
<html lang="en-US">
<head>
